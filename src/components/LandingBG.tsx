...
const LandingBG = () => {
  ...
  useLayoutEffect(() => {
    gsap.fromTo(
      ".belon0",
      { y: 1000 },
      { y: -1000, duration: 2, delay: 2, ease: "none" }
    );
    gsap.fromTo(
      ".belon1",
      { y: 1000 },
      { y: -1000, duration: 2, delay: 2.7, ease: "none" }
    );
    gsap.fromTo(
      ".belon2",
      { y: 1000 },
      { y: -1000, duration: 2, delay: 3, ease: "none" }
    );
    gsap.fromTo(
      ".belon3",
      { y: 1000 },
      { y: -1000, duration: 2, delay: 2.85, ease: "none" }
    );

    gsap.fromTo(
      ".kamera",
      { y: 1000 },
      { y: 0, x: 100, duration: 4, delay: 3.3, ease: "elastic" }
    );
      ...
      <div ref={app} className="flex justify-between absolute z-100">
        {Array.from({ length: 7 }, (_, i) => (
          <Image
            ...
            width={40}
            key={i}
            className={"w-[15vw] belon" + Math.abs(3 - i)}
            src="/belon.png"
          />
        ))}
      </div>
